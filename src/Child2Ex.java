...
//        자동 타입 변환
//        부모 클래스 타입의 변수에 자식 클래스 타입의 객체를 대입하면 부모 클래스 타입의 멤버만 사용이 가능함
//     (알맹이는 자식 클래스 타입의 객체)
...
//
        ...
        child21.field1 = "상속받은 멤버변수";
        child21.field2 = "Child2 전용으로 가지고 있는 멤버변수";
...
//        System.out.println("객체 parent21의 field1 출력 : " + parent21.field2);
...
//        원본 객체를 자식 클래스 타입의 변수로 타입 변환 시  해당 객체의 모든 멤버를 가지고 있는지 알 수 없기 때문에
//      강제 타입변환을 해야 함.
...
////        자식 클래스 타입의 변수 선언
//        Child2 child23;
////        자식 클래스 타입의 변수에 부모 클래스 타입의 객체 대입
////        문법상 오류는 없으나 원본이 자식 클래스 타입의 객체가 아니기 때문에 런타임에러가 발생
...
//        원본 객체가 변환하려는 클래스 타입의 객체가 아닐 수 있기 떄문에 오류가 발생할 수 있음
        Child2 child = (Child2) parent;
